...
import com.gutk.pontoonline.api.endpoint.response.exceptions.EntityInUseException;
import com.gutk.pontoonline.api.endpoint.response.exceptions.EntityNotFoundException;
import com.gutk.pontoonline.api.endpoint.response.exceptions.ValidationException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			...
			body = ApiError.Builder.newbuilder().status(status.value()).title((String) body)
					.userMessage(GENERIC_ERROR_MESSAGE).timestamp(OffsetDateTime.now()).build();
		}
