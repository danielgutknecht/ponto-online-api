...
import com.gutk.pontoonline.api.endpoint.response.exceptions.ResourceUriHelper;
...
@CrossOrigin(origins = "*")
public class EmpresaController implements EmpresaAnswerApi
{
	...
	public EmpresaDTO save(@RequestBody @Valid EmpresaDTOInput empresaInput)
	{
		try
		{
			...
			return empresaMapperManual.toModel(empresaService.criarEmpresa(empresa));
